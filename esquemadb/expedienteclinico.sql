...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-05-2017 a las 13:17:41
...
(15, 4, 'Tipo de Personal', 'Descripción del personal interno de la clínica', 'ACTIVO', 'TipoPersonal'),
...
(20, 7, 'Reporte Factura', 'Creación de Factura', 'ACTIVO', 'ReporteFactura'),
...
(1, '2012-001', '2017-04-26 01:08:13', 'Carlos', 'Martinez', '1990-07-12 06:00:00', '001-210982-009U', '86680546', '223456678', 'aguirretellez96@gmai', 'Villa Venezuela', 'Soltero', 'O +', 'MASCULINO', 'ACTIVO'),
...
INSERT INTO `usuario` (`usu_id`, `prf_id`, `pd_id`, `usu_username`, `usu_contrasena`, `usu_fecha_inicio`, `usu_fecha_caducidad`, `usu_estado`) VALUES
(1, 1, NULL, 'admin', '81dc9bdb52d04dc20036dbd8313ed055', '2017-03-23 16:22:15', NULL, 'ACTIVO');
...
--
ALTER TABLE `prf_form`
  MODIFY `prfm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
