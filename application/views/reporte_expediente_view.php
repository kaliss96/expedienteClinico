	...
	<div class="row">
		<div class="col-xs-12">
			...
			<table id="grid" class="table table-hover table-bordered table-striped table-condensed">
				...
				<tbody>
					<?php foreach ($lista_reporteExpedienteExistente as $fila) { ?>
					<tr class="<?php echo $fila->estado == 'INACTIVO' ? 'danger' : '' ?>">
						<td><?php echo $fila->fecha_registro;?></td>
						<td><?php echo $fila->numero;?></td>
						<td><?php echo $fila->nombre_paciente;?> <?php echo $fila->apellido;?></td>          
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="lblVistaImprimir">Reporte Expediente</h4>
			</div>
...
<script type="text/javascript">
	var lista_reporteExpedienteExistente = <?php echo json_encode($lista_reporteExpedienteExistente) ?>;
	console.log(lista_reporteExpedienteExistente);
