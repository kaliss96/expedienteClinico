<div class="page-content">
	<div class="page-header">
		<h1>Epicrisis de los Pacientes</h1>
	</div><!-- /.page-header -->
	...
	<div class="row">
		...
		<?php } ?>	
			...
			<?php foreach ($lista_epicrisis as $fila) { ?>
		...
		<?php if ($prfm_actualiza == 1){ ?>	
		  <button class="btn btn-info btn-xs" onclick="editarEpicrisis(<?php echo $fila->id ?>)"><span class="fa fa-pencil"></span></button>
		<?php } ?>  
		  <?php if ($fila->estado == 'ACTIVO') {
...
<!-- Modal -->
<div class="modal fade" id="ModalEpicrisis" tabindex="-1" role="dialog" aria-labelledby="myModalEpicrisis">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="myModalEpicrisis">Registro de Epicrisis</h4>
			</div>
			<?php echo form_open('Epicrisis/registrar_Epicrisis','class="myclass"');?>
			...
			<div class="modal-body">
				...
				<ul class="nav nav-tabs" id="tabContent">
				        ...
				        <li><a href="#segundo" data-toggle="tab">ENFERMEDADES</a></li>
				        <li><a href="#tercero" data-toggle="tab">DIAGNOSTICOS</a></li>
				        <li><a href="#cuarto" data-toggle="tab">CIRUGÍAS</a></li>
				        <li><a href="#quinto" data-toggle="tab">DETALLE CIRUGÍA</a></li>
				</ul>
								...
								<tr>
									...
									<td>
										<div class="form-group">
											...
											<input name="clinica" placeholder="Clínica" class="form-control" />						
										</div>
									</td>
									<td>
										<div class="form-group">
											<label for="sala">SALA:</label>
											<input name="sala" placeholder="Sala" class="form-control" />						
										</div>
									</td>
								</tr>			
							</tbody>				
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<input name="no_cama" placeholder="Número de Cama" class="form-control" />						
										</div>
									</td>
									<td>
										<div class="form-group">
											<label for="enfermedad">ENFERMEDAD:</label>
											<textarea name="enfermedad" class="form-control" rows="4" name="message" placeholder="Enfermedad"></textarea>		
										</div>
									</td>					
								</tr>			
							</tbody>				
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<textarea name="complicaciones" class="form-control" rows="4" name="message" placeholder="Detalle Enfermedad"></textarea>
										</div>
									</td>
									<td>
										<div class="form-group">
											<label for="examenes_realizados">EXAMENES REALIZADOS:</label>
											<textarea name="examenes_realizados" class="form-control" rows="4" name="message" placeholder="Examenes Realizados"></textarea>					
										</div>
									</td>								
								</tr>			
							</tbody>				
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<textarea name="tratamientos_recibidos" class="form-control" rows="4" name="message" placeholder="Examenes Realizados"></textarea>						
										</div>
									</td>					
								</tr>			
							</tbody>				
								...
								<tr>
									<td>
										<div class="form-group">
												...
												<textarea name="diagnostico_ingreso" class="form-control" rows="4" name="message" placeholder="Diagnostíco Ingreso"></textarea>
											</div>
									</td>
									</tr>
									<tr>
									<td>
										<div class="form-group">
											...
											<textarea name="diagnostico_egreso" class="form-control" rows="4" name="message" placeholder="Diagnostíco Egreso"></textarea>
										</div>
									</td>
								</tr>			
							</tbody>				
								...
								<tr>
									<td>
										<div class="form-group">
											...
											<textarea name="cirugia" class="form-control" rows="4" name="message" placeholder="cirugías"></textarea>	
										</div>
									</td>
									<td>
										<div class="form-group">
												<label for="resultado_examen" class="control-label">RESULTADO EXAMEN:</label>
												<textarea name="resultado_examen" class="form-control" rows="4" name="message" placeholder="Resultado Examen"></textarea>
											</div>
									</td>			
								</tr>			
							</tbody>				
						...
						<table class="table table-hover">
							<td>
								<div class="form-group">
									...
									<textarea name="motivo_cirugia" class="form-control" rows="4" name="message" placeholder="Motivo de Cirugía"></textarea>
								</div>
							</td>
						</table>
					</div>
	...
	<div class="modal fade" id="ModalActualizar" tabindex="-1" role="dialog" aria-labelledby="myModalActualizar">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					<h4 class="modal-title" id="myModalActualizar">Actualizar Epicrisis</h4>
				</div>
				<?php echo form_open('Epicrisis/actualizar','class="myclass"');?>
					<input type="text" name="txtEpicrisisId" id="txtEpicrisisId" class="hide" />
...
<!-- Modal Cambio Estado -->
	<div class="modal fade" id="ModalEstado" tabindex="-1" role="dialog" aria-labelledby="lblModalEstado">
		<div class="modal-dialog modal-sm" role="document">
			<div class="modal-content">
				...
				<form method="post" action="<?php echo site_url('Epicrisis/cambiarEstado') ?>">
					<input type="text" name="estado_epicrisis_id" id="estado_epicrisis_id" class="hide" />
	...
	<script type="text/javascript">
	  var lista_epicrisis = <?php echo json_encode($lista_epicrisis) ?>;
	  console.log(lista_epicrisis);
